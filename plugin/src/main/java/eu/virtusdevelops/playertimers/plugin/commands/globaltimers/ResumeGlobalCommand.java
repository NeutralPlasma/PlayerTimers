...
public class ResumeGlobalCommand implements AbstractCommand {
    ...
    @Command("timers global resume <name>")
    ...
    public void cancelCommand(
        ...
        if(timer.resume()){
            sender.sendMessage(TextUtil.MM.deserialize("<green>Resumed timer"));
        }else{
            sender.sendMessage(TextUtil.MM.deserialize("<red>Timer is not paused"));
        }
    }
