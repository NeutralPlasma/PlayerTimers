...
public class StopGlobalCommand implements AbstractCommand {
    ...
    @Command("timers global stop <name>")
    ...
    public void cancelCommand(
        ...
        timer.finish();
        sender.sendMessage(TextUtil.MM.deserialize("<green>Stopped timer"));
    }
